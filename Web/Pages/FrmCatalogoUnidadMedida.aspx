<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeBehind="FrmCatalogoUnidadMedida.aspx.cs" Inherits="Web.Pages.FrmCatalogoUnidadMedida" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="borde_redondo_tabla">
        ...
        <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server" GridViewID="ASPxGridView1">
            ...
            <PageHeader Center="Facturación Web - Catálogo de Unidad Medida">
