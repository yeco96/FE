<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeBehind="FrmConsultaProformas.aspx.cs" Inherits="Web.Pages.Facturacion.FrmConsultaProformas" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
   <div class="text-box-title">
        <div class="text-box-heading-title">Resumen Proformas</div>
