<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeBehind="FrmNotaCredito.aspx.cs" Inherits="Web.Pages.Facturacion.FrmNotaCredito" %>
        ...
        <Items>
            ...
            <dx:LayoutGroup Caption="Datos del Documento de Referencia" ColCount="2" GroupBoxDecoration="Box" UseDefaultPaddings="false">
                <Items>
                    ...
                    <dx:LayoutItem Caption="Clave Factura Electrónica">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                    ...
                    <dx:LayoutItem Caption="Fecha de la Factura Electrónica">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
            ...
            <%-- Datos del Emisor --%>
            <dx:LayoutGroup Caption="Datos del Emisor" ColCount="2" GroupBoxDecoration="Box" UseDefaultPaddings="false">
                <Items>
                    ...
                    <dx:LayoutItem Caption="Nombre del Emisor">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxTextBox ID="txtNombreEmisor" runat="server" Width="100%" AutoResizeWithContainer="true" Enabled="false">
                                    <ValidationSettings>
                                        <RequiredField IsRequired="true" />
                                    </ValidationSettings>
                                </dx:ASPxTextBox>
            ...
            <%-- Datos del Receptor --%>
            <dx:LayoutGroup Caption="Datos del Receptor" ColCount="2" GroupBoxDecoration="Box" UseDefaultPaddings="false">
                <Items>
                    <dx:LayoutItem Caption="Número Cédula Receptor">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                    ...
                    <dx:LayoutItem Caption="Nombre del Receptor">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxTextBox ID="txtNombreReceptor" runat="server" Width="100%" AutoResizeWithContainer="true" Enabled="false">
                                    <ValidationSettings>
                                        <RequiredField IsRequired="true" />
                                    </ValidationSettings>
                                </dx:ASPxTextBox>
                    ...
                    <dx:LayoutItem Caption="Correo electrónico">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxTextBox ID="txtCorreoReceptor" runat="server" Width="100%" AutoResizeWithContainer="true" Enabled="true">
                                    <ValidationSettings>
                                        <RequiredField IsRequired="true" />
                                    </ValidationSettings>
                                </dx:ASPxTextBox>
