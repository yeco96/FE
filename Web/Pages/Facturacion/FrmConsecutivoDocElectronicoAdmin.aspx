<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeBehind="FrmConsecutivoDocElectronicoAdmin.aspx.cs" Inherits="Web.Pages.Facturacion.FrmConsecutivoDocElectronicoAdmin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
     ...
     <div class="text-box-title">
        <div class="text-box-heading-title">Mantenimiento Consecutivo</div>
    ...
    <div class="borde_redondo_tabla">
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" ClientInstanceName="ASPxGridView1" KeyboardSupport="True"
            Width="100%" EnableTheming="True" KeyFieldName="emisor;sucursal;caja;tipoDocumento" Theme="Moderno"
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="Emisor" FieldName="emisor" VisibleIndex="2" PropertiesTextEdit-MaxLength="12"
                    PropertiesTextEdit-ValidationSettings-RequiredField-IsRequired="true" PropertiesTextEdit-ValidationSettings-RequiredField-ErrorText="Requerido">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Sucursal" FieldName="sucursal" VisibleIndex="3" PropertiesTextEdit-MaxLength="3" 
                    PropertiesTextEdit-ValidationSettings-RequiredField-IsRequired="true" PropertiesTextEdit-ValidationSettings-RequiredField-ErrorText="Requerido">
                </dx:GridViewDataTextColumn>
                ...
                <dx:GridViewDataTextColumn Caption="Dígito Verificador" FieldName="digitoVerificador" VisibleIndex="5" PropertiesTextEdit-MaxLength="8"
                    PropertiesTextEdit-ValidationSettings-RequiredField-IsRequired="true" PropertiesTextEdit-ValidationSettings-RequiredField-ErrorText="Requerido">
                </dx:GridViewDataTextColumn>
                ...
                <dx:GridViewDataTextColumn Visible="false" Caption="Usuario Creación" FieldName="usuarioCreacion" VisibleIndex="7">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataDateColumn Visible="false" Caption="Fecha Creación" FieldName="fechaCreacion" VisibleIndex="8">
                    <PropertiesDateEdit EditFormat="DateTime" DisplayFormatstring="" EditFormatstring="dd/MM/yyyy hh:mm:ss"></PropertiesDateEdit>
                </dx:GridViewDataDateColumn>
                <dx:GridViewDataTextColumn  Visible="false" Caption="Usuario Modificación" FieldName="usuarioModificacion" VisibleIndex="9">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataDateColumn Visible="false" Caption="Fecha Modificación" FieldName="fechaModificacion" VisibleIndex="10">
                    <PropertiesDateEdit EditFormat="DateTime" DisplayFormatstring="" EditFormatstring="dd/MM/yyyy hh:mm:ss"></PropertiesDateEdit>
                </dx:GridViewDataDateColumn>
            </Columns>
