<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeBehind="FrmAdministracionDocElectronicoAdmin.aspx.cs" Inherits="Web.Pages.Facturacion.FrmAdministracionDocElectronicoAdmin" %>
                            ...
                            <dx:LayoutGroup Caption=" " ColCount="4" GroupBoxDecoration="None" UseDefaultPaddings="false">
                                ...
                                <Items>
                                    ...
                                    <dx:LayoutItem Caption="">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxButton ID="btnDescargarPDF" Width="100%" AutoResizeWithContainer="true"  runat="server" Text="Descargar PDF" OnClick="btnDescargarPDF_Click" Image-Url="~/Content/Images/pdf2.png"></dx:ASPxButton>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
