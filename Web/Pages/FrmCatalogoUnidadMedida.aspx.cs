...
namespace Web.Pages
{
    public partial class FrmCatalogoUnidadMedida : System.Web.UI.Page
    {
        ...
        {
            // if (e.Column.FieldName == "idUnidadMedida") { e.Editor.ReadOnly = true; e.Column.ReadOnly = true; e.Editor.BackColor = System.Drawing.Color.LightGray; }
        ...
        {
            this.ASPxGridViewExporter1.FileName = String.Format("ListaUnidadMedida{0}", DateTime.Now.ToString("yyyyMMdd"));
