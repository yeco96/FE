...
namespace Web.Pages.Catalogos
{
    ...
    public partial class FrmCatalogoCodigoPais : System.Web.UI.Page
    {
        ...
        private void refreshData()
        {
            ...
            {
                this.ASPxGridView1.DataSource = conexion.CodigoPais.ToList();
        ...
        protected void ASPxGridView1_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            try
            {
                using (var conexion = new DataModelFE())
                {
                    ...
                    //busca objeto
                    var itemToRemove = conexion.CodigoPais.SingleOrDefault(x => x.codigo == id);
                    conexion.CodigoPais.Remove(itemToRemove);
                    conexion.SaveChanges();
