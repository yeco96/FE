...
namespace Web.Pages.Catalogos
{
    public partial class FrmCatalogoCondicionVenta : System.Web.UI.Page
    {
        ...
        private void refreshData()
        {
            ...
            {
                this.ASPxGridView1.DataSource = conexion.CondicionVenta.ToList();
        ...
        protected void ASPxGridView1_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            try
            {
                using (var conexion = new DataModelFE())
                {
                    ...
                    //agrega el objeto
                    conexion.CondicionVenta.Add(dato);
        ...
        protected void ASPxGridView1_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            try
            {
                using (var conexion = new DataModelFE())
                {
                    ...
                    //busca el objeto 
                    CondicionVenta oldDato = conexion.CondicionVenta.Find(dato.codigo);
                    dato = oldDato;
        ...
        protected void ASPxGridView1_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            try
            {
                using (var conexion = new DataModelFE())
                {
                    ...
                    //busca objeto
                    var itemToRemove = conexion.CondicionVenta.SingleOrDefault(x => x.codigo == id);
                    conexion.CondicionVenta.Remove(itemToRemove);
                    conexion.SaveChanges();
