...
namespace Web.Pages.Catalogos
{
    public partial class FrmCatalogoMedioPago : System.Web.UI.Page
    {
        ...
        {
            this.ASPxGridView1.DataSource = this.dataModelFE.MedioPago.ToList();
        ...
        protected void ASPxGridView1_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            try
            {
                ...
                //agrega el objeto
                this.dataModelFE.MedioPago.Add(dato);
            ...
            catch (DbEntityValidationException ex)
            {
               ...
               // DataModelFE.GetInstance().MedioPago.Remove(DataModelFE.GetInstance().MedioPago.Last() );
        ...
        protected void ASPxGridView1_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            ...
            { 
                ...
                //busca el objeto 
                MedioPago oldDato = DataModelFE.GetInstance().MedioPago.Find(dato.codigo);
                dato = oldDato;
        ...
        protected void ASPxGridView1_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            try
            {
                ...
                //busca objeto
                var itemToRemove = DataModelFE.GetInstance().MedioPago.SingleOrDefault(x => x.codigo == id);
                DataModelFE.GetInstance().MedioPago.Remove(itemToRemove);
                DataModelFE.GetInstance().SaveChanges();
