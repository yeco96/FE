<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeBehind="FrmCatalogoCodigoReferencia.aspx.cs" Inherits="Web.Pages.Catalogos.FrmCatalogoCodigoReferencia.aspx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <section class="featured">
        <div class="content-wrapper">
            Mantenimiento Código Referencia
        </div>
    </section>
    <br />
    <div class="borde_redondo_tabla">
        ...
        <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server" GridViewID="ASPxGridView1" FileName="Catálogo Código Referencia">
            <Styles>
                <Default Font-Names="Arial" Font-Size="Small" />
            </Styles>
            <PageHeader Center="Facturación Web - Catálogo Código Referencia">
