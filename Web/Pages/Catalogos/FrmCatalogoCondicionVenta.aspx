<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeBehind="FrmCatalogoCondicionVenta.aspx.cs" Inherits="Web.Pages.Catalogos.FrmCatalogoCondicionVenta" %>
    ...
    <div class="borde_redondo_tabla">
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" ClientInstanceName="ASPxGridView1" KeyboardSupport="True"
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="Descripción Inglés" FieldName="descripcionEN" VisibleIndex="3" PropertiesTextEdit-MaxLength="50"
                    PropertiesTextEdit-ValidationSettings-RequiredField-IsRequired="true" PropertiesTextEdit-ValidationSettings-RequiredField-ErrorText="Requerido">
                </dx:GridViewDataTextColumn>
        ...
        <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server" GridViewID="ASPxGridView1" FileName="Catálogo Condición Venta">
            <Styles>
                <Default Font-Names="Arial" Font-Size="Small" />
            </Styles>
            <PageHeader Center="Facturación Web - Catálogo Condición Venta">
