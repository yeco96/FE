...
{
    public partial class FrmCatalogoTipoIdentificacion : System.Web.UI.Page
    {
        ...
        /// constructor
        /// </summary>
        public FrmCatalogoTipoIdentificacion()
        { 
        ...
        {
            this.ASPxGridView1.DataSource = this.dataModelFE.TipoIdentificacion.ToList();
        ...
        protected void ASPxGridView1_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            try
            {
                ...
                dato.descripcion = e.NewValues["descripcion"] != null ? e.NewValues["descripcion"].ToString().ToUpper().ToUpper() : null;
                ...
                //agrega el objeto
                this.dataModelFE.TipoIdentificacion.Add(dato);
        ...
        protected void ASPxGridView1_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            try
            {
                ...
                //busca el objeto 
                TipoIdentificacion oldDato = DataModelFE.GetInstance().TipoIdentificacion.Find(dato.codigo);
                dato = oldDato;
        ...
        protected void ASPxGridView1_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            try
            {
                ...
                //busca objeto
                var itemToRemove = DataModelFE.GetInstance().TipoIdentificacion.SingleOrDefault(x => x.codigo == id);
                DataModelFE.GetInstance().TipoIdentificacion.Remove(itemToRemove);
                DataModelFE.GetInstance().SaveChanges();
