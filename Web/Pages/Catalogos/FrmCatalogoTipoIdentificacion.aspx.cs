...
namespace Web.Pages.Catalogos
{
    public partial class FrmCatalogoTipoIdentificacion : System.Web.UI.Page
    {
        ...
        private void refreshData()
        {
            ...
            {
                this.ASPxGridView1.DataSource = conexion.TipoIdentificacion.ToList();
        ...
        protected void ASPxGridView1_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            try
            {
                using (var conexion = new DataModelFE())
                {
                    ...
                    //agrega el objeto
                    conexion.TipoIdentificacion.Add(dato);
            ...
            catch (DbEntityValidationException ex)
            {
                ...
                // conexion.TipoIdentificacion.Remove(conexion.TipoIdentificacion.Last() );
        ...
        protected void ASPxGridView1_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            try
            {
                using (var conexion = new DataModelFE())
                {
                    ...
                    //busca el objeto 
                    TipoIdentificacion oldDato = conexion.TipoIdentificacion.Find(dato.codigo);
                    dato = oldDato;
        ...
        protected void ASPxGridView1_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            try
            {
                using (var conexion = new DataModelFE())
                {
                    ...
                    //busca objeto
                    var itemToRemove = conexion.TipoIdentificacion.SingleOrDefault(x => x.codigo == id);
                    conexion.TipoIdentificacion.Remove(itemToRemove);
                    conexion.SaveChanges();
