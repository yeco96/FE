<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeBehind="FrmCatalogoCodigoReferencia.aspx.cs" Inherits="Web.Pages.FrmCatalogoCodigoReferencia.aspx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <section class="featured">
        <div class="content-wrapper">
            Mantenimiento Codigo de Referencia
        </div>
    </section>
    <br />
    <div class="borde_redondo_tabla">
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" ClientInstanceName="ASPxGridView1" KeyboardSupport="True"
            ...
            <Columns>
                ...
                <dx:GridViewDataComboBoxColumn Caption="Estado" FieldName="estado" Width="80px" VisibleIndex="4"
            ...
            <Settings VerticalScrollBarMode="Hidden" VerticalScrollableHeight="350" VerticalScrollBarStyle="Standard" ShowGroupPanel="True" ShowFilterRow="True" ShowTitlePanel="True" UseFixedTableLayout="True" />
        ...
        <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server" GridViewID="ASPxGridView1">
            ...
            <PageHeader Center="Facturación Web - Catálogo Código de Referencia">
