<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.master" AutoEventWireup="true" CodeBehind="FrmCatalogoCondicionVenta.aspx.cs" Inherits="Web.Pages.FrmCatalogoCondicionVenta" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="borde_redondo_tabla">
        ...
        <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server" GridViewID="ASPxGridView1">
            ...
            <PageHeader Center="Facturación Web - Catálogo de Condición Venta">
