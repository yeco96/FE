...
namespace XMLDomain
{
    ...
    public class ProformaElectronica : ProformaElectronico
    {  
        ...
        public ProformaElectronica()
        {
            ...
            this.resumenProforma = new ResumenFacturaProforma();
        ...
        public void iniciarParametros()
        {
            ...
            this.resumenProforma = new ResumenFacturaProforma();
            this.resumenProforma.codigoMoneda = "CRC";
            this.resumenProforma.totalServGravados = 0;
            this.resumenProforma.totalServExentos = 1900000000;
            this.resumenProforma.totalMercanciasGravadas = 0;
            this.resumenProforma.totalMercanciasExentas = 0;
            this.resumenProforma.totalGravado = 0;
            this.resumenProforma.totalExento = 1900000000;
            this.resumenProforma.totalVenta = 1900000000;
            this.resumenProforma.totalDescuentos = 380000000;
            this.resumenProforma.totalVentaNeta = 1520000000;
            this.resumenProforma.totalImpuesto = 0;
            this.resumenProforma.totalComprobante = 1520000000;
